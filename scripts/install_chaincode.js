...
// --- Set Details Here --- //
var config_file = 'parts_local.json';							//set config file name
var chaincode_id = 'parts';									//set desired chaincode id to identify this chaincode
var chaincode_ver = 'v0.1';										//set desired chaincode version
...
fcw.enrollWithAdminCert(helper.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		var opts = {
			...
			path_2_chaincode: 'parts',				//path to chaincode from <parts root>/chaincode/src/
